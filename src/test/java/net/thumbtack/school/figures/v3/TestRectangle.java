...
public class TestRectangle {
    ...
    public void newTestRectangle() throws ColorException {
        Point2D topLeft = new Point2D(10, 20);
        Point2D bottomRight = new Point2D(30, 40);
        Rectangle rect = new Rectangle(new Point2D(1, 2), new Point2D(3, 4), "BLUE");
        rect.setColor("RED");
        assertEquals(rect.getColor(), Color.RED);
        rect.setTopLeft(topLeft);
        rect.setBottomRight(bottomRight);
        assertEquals(topLeft, rect.getTopLeft());
        assertEquals(bottomRight, rect.getBottomRight());
    }
}
