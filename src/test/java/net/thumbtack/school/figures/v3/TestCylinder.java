...
public class TestCylinder {
    ...
    @Test
    public void newTestCylinder() throws ColorException {

        Cylinder cylinder = new Cylinder(10, 10, Color.BLUE);
        Cylinder cylinder1 = new Cylinder(10, 10, "BLUE");
        Cylinder cylinderA = new Cylinder(10, 10, Color.RED);

        Cylinder cylinder2 = new Cylinder(Color.BLUE);
        Cylinder cylinder3 = new Cylinder("BLUE");
        assertEquals(cylinder, cylinder1);
        assertEquals(cylinder2, cylinder3);
        assertNotEquals(cylinderA, cylinder1);
        cylinder.setHeight(50);
        assertEquals(50, cylinder.getHeight());
