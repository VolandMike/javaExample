...
public class TestRectangle3D {
    ...
    @Test
    public void newTestRectangle() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 10, Color.BLUE);
        rect3D.setHeight(30);
        assertEquals(30, rect3D.getHeight());

    }

    @Test
    public void newTestIsRectangleInsideRectangle3D() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 10, Color.BLUE);
        assertFalse(rect3D.isInside(10, 10, 10));
        assertFalse(rect3D.isInside(new Point3D(10, 10, 10)));
        assertTrue(rect3D.isInside(10, 20, 0));
        assertTrue(rect3D.isInside(new Point3D(10, 20, 0)));
