...
public class TestCircle {
    ...
    @Test
    public void newTestSetCenter() throws ColorException {
        Point2D center = new Point2D(10, 20);
        Point2D centerNew = new Point2D(30, 40);
        Circle circleFirst = new Circle(10, 20, 10, "BLUE");
        Circle circle = new Circle(10, 20, 10, Color.BLUE);
        Circle circleTwo = new Circle(10, Color.BLUE);
        Circle circleThree = new Circle(10, "RED");
        Circle circleFour = new Circle(Color.RED);
        Circle circleFife = new Circle("RED");
        assertNotEquals(circleTwo, circleThree);
        assertEquals(circleFour, circleFife);
        assertEquals(circle, circleFirst);
        circle.setCenter(centerNew);
        assertEquals(circle.getCenter(), centerNew);
    }

    @Test
    public void newTestSetColor() throws ColorException {
        Circle circleFirst = new Circle(10, 20, 10, "BLUE");
        Circle circleTwo = new Circle(10, 20, 10, Color.BLUE);
        circleFirst.setColor("RED");
        assertNotEquals(circleFirst, circleTwo);
