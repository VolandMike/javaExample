...
public class TestFigure {
    ...
    public void testEqualsFigure() throws ColorException {
        Figure circle1 = new Circle(new Point2D(10, 10), 10, Color.BLUE);
        circle1.setColor("BLUE");
        Figure circle2 = new Circle(new Point2D(10, 10), 10, Color.BLUE);
        circle2.setColor(Color.BLUE);
        Figure circle3 = new Circle(new Point2D(10, 10), 20, Color.BLUE);
        Figure circle4 = new Circle(new Point2D(0, 0), 20, Color.BLUE);
        Figure circle5 = new Circle(new Point2D(10, 10), 10, Color.GREEN);
